<template>
  <div class="article">
    ...
    <div class="post-head">
      <Date
        :date="presenter.props.publishedAt ? presenter.props.publishedAt : ''"
      />
    </div>
    ...
    <div class="heading-inner">
      <picture class="heading-img">
        <source
          :srcset="presenter.props.webp.fields.file.url"
          type="image/webp"
        />
        <img
          :src="presenter.props.image.fields.file.url"
          :alt="presenter.props.image.fields.file.fileName"
        />
      </picture>
    </div>
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: "og:image",
          property: "og:image",
          content: post ? `https:${post.image.fields.file.url}` : "",
        },
        {
          hid: "og:url",
          property: "og:url",
          content: `https://kumamo-n.com/posts/${post ? post.slug : ""}`,
        },
      ],
    };
  },

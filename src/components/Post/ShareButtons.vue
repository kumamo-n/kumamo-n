<template>
  ...
  <div class="share_buttons">
    ...
    <a :href="`http://b.hatena.ne.jp/entry/${this.pagePath}`" >
    ...
    <a :href="`http://twitter.com/share?url=${this.pagePath}&text=${this.title}`"  target="_blank" rel="noopener">
      <svg width="20px" height="40px"viewBox="0 0 20 16">
        <use xlink:href="/twitter.svg#root" />
      </svg>
    </a>
    <a :href="`http://getpocket.com/edit?url=${this.pagePath}`"  target="_blank" rel="noopener">
      <svg width="20px" height="40px" viewBox="0 0 20 16">
